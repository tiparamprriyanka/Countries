...
//   alert('Welcome to the API! Click OK to fetch data.');
// }
...
//       if (result) {
//         // If the user clicks OK, fetch data
//         fetchData();
...
//       const result = confirm('Welcome to the API! Click OK to fetch data.');
//       if (result) {
//         // If the user clicks OK, hide the homepage title and fetch data
...
// const searchInput = document.querySelector('.search-container input');
// const themeChanger = document.querySelector('.theme-changer');
// const sortSelect = document.querySelector('.sort-select'); // Added reference to sorting select
// let allCountriesData;
// let alertShown = false;
...
//   const sortedData = sortCountries(data); // Sort the data based on the selected sorting option
...
//   renderCountries(allCountriesData); // Trigger a re-render to apply sorting
// });
...
// // Helper function to sort countries based on the selected option
